...
namespace rdeuber_local_planner {
  void RDEUBERPlanner::reconfigure(RDEUBERPlannerConfig &config)
  {
  ...
  RDEUBERPlanner::RDEUBERPlanner(std::string name, base_local_planner::LocalPlannerUtil *planner_util) :
      ...
      alignment_costs_(planner_util->getCostmap())
  {
    ...
    map_viz_.initialize(name, planner_util->getGlobalFrame(), boost::bind(&RDEUBERPlanner::getCellCosts, this, _1, _2, _3, _4, _5, _6));
  ...
  bool RDEUBERPlanner::getCellCosts(int cx, int cy, float &path_cost, float &goal_cost, float &occ_cost, float &total_cost) {
  ...
  bool RDEUBERPlanner::setPlan(const std::vector<geometry_msgs::PoseStamped>& orig_global_plan) {
    oscillation_costs_.resetOscillationFlags();
   ...
   */
  bool RDEUBERPlanner::checkTrajectory(
      Eigen::Vector3f pos,
      Eigen::Vector3f vel,
  ...
  void RDEUBERPlanner::updatePlanAndLocalCosts(
   ...
   */
  base_local_planner::Trajectory RDEUBERPlanner::findBestPath(
      const geometry_msgs::PoseStamped& global_pose,
